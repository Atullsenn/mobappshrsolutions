...
const AddSickness = () => {
    ...
    const addEmployeeSickLeave = async()=>{
        let request = {

        }
        await axios.post(`${BASE_URL}/addSickLeave`,request,{
            Accept: "Application",
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-3 col-md-3 position-rel">
                                                            <div className="position-rel">
                                                                <input type="text" onClick={showSelect} placeholder="Employees name" class="form-control"
                                                                    id="staticEmail" />
