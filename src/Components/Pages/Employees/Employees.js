...
const defaultState = {
    ...
    workingWeek: '10',
    publicholidays: '7',
    AnnualLeaveStartDate: '01-06-2023',
...
const Employees = () => {
    ...
    const EmployeeToastMessage = ({ type, message }) => {
    ...
    const handleAddEmployee = () => {
        handleShowLoader()
        axios.post(`${BASE_URL}/addEmployee`, {
            first_name: state.firstName,
            last_name: state.lastName,
            email: state.email,
            start_date: state.employeeStartDate,
            employee_type: state.employeeType,
            working_time_pattern: state.workingTimePattern,
            working_week: state.workingWeek,
            public_holidays: state.publicholidays,
            annual_leave_start_date: state.AnnualLeaveStartDate
        }).then((response) => {
            EmployeeToastMessage({ type: true, message: 'Employee Added Successfully' })
            getEmployeeRecordData()
        }).catch((error) => {
            console.log(error)
            EmployeeToastMessage({ type: false, message: 'Something Went Wrong Employee was not added' })
            setTimeout(() => {
                handleHideLoader()
            }, 500);
        })
    ...
    return (
        <>
            <div>
                ...
                >
                    <CircularProgress style={{ height: '65px', width: '65px', color: "#1f88b5" }} />
                </Backdrop>
            </div>
                                                                                                    ...
                                                                                                    <div className="col-md-12"
                                                                                                        ...
                                                                                                        <form
                                                                                                            ...
                                                                                                            <div className="row">
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        id="firstName"
                                                                                                                        name='firstName'
                                                                                                                        onChange={(e) => { addEmployeeHandler(e) }}
                                                                                                            ...
                                                                                                            <div className="row">
                                                                                                                <label
                                                                                                                    id="firstDate"
                                                                                                                    className="col-sm-2 col-form-label">Employment start date
                                                                                                                </label>
                                                                                                                <div
                                                                                                                    className="col-md-3">
                                                                                                                    <input
                                                                                                            ...
                                                                                                            <div className="col-md-4" onClick={() => {
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div className="bg-color">
                                                                                                                        <h5>Fixed, full or part time </h5>
                                                                                                                        <p> Employees on a repeating working time pattern who work fixed, predictable number of hours every week and have a fixed leave entitlement
                                                                                                                        </p>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                                ...
                                                                                                                <div onClick={() => {
                                                                                                                    ...
                                                                                                                    <div className="card-1 card-btn">
                                                                                                                        <input
                                                                                                                            ...
                                                                                                                            name="radio-btn" />
                                                                                                                        <div className="bg-color">
                                                                                                                            <h5>Short hours or variable </h5>
                                                                                                                            <p>{`Employees on a contract who work a different number of hours or days from week to week (but not zero-hours contracts)`}
                                                                                                                            </p>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                        ...
                                                                                                        <div className="col-md-12">
                                                                                                            <form action="">
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        className="col-sm-2">
                                                                                                                        <select className="form-select form-control" name='workingTimePattern' onChange={(e) => { addEmployeeHandler(e) }}>
                                                                                            ...
                                                                                            <div className="col-md-12">
                                                                                                <div
                                                                                                    ...
                                                                                                    <div className="row my-4">
                                                                                                        <div className="col-md-12">
                                                                                                            <h5>Summary</h5>
                                                                                                            <p>You're about to add
                                                                                                                <b style={{ fontWeight: '500' }}>test test</b>
                                                                                                                to the company.
                                                                                                            </p>
                                                                                                        </div>
                                                                                                        <div className="col-md-12">
                                                                                                            <div className="parent-border my-3">
                                                                                                                <div className="d-flex justify-content-between p-3 B-bottom">
                                                                                                                    <div>Employee start date </div>
                                                                                                                    <div><b>{state.employeeStartDate}</b></div>
                                                                                                                </div>
                                                                                                                <div className="d-flex justify-content-between p-3 B-bottom">
                                                                                                                    <div>Leave year start date</div>
                                                                                                                    <div><b>01 January</b></div>
                                                                                                                </div>
                                                                                                                <div className="d-flex justify-content-between p-3 B-bottom">
                                                                                                                    <div>Company's full time annual leave entitlement</div>
                                                                                                                    <div><b>29 Nov 2022</b></div>
                                                                                                                </div>
                                                                                                                <div className="d-flex justify-content-between p-3 B-bottom">
                                                                                                                    <div>Employee start date </div>
                                                                                                                    <div><b>{state.employeeStartDate}</b></div>
                                                                                                                ...
                                                                                                                <div className="d-flex justify-content-between p-3 B-bottom">
                                                                                                                    <div>Allowance for leave year 01 Jan 2022 31 Dec 2022</div>
                                                                                                                    <div><b>0 days</b></div>
                                                                                                                </div>
                                                                                                                <div className="d-flex justify-content-between p-3 B-bottom">
                                                                                                                    <div>Working time pattern</div>
                                                                                                                    <div><b>0 days</b></div>
                                                                                                                </div>
                                                                                                                <div className="d-flex justify-content-between p-3 B-bottom">
                                                                                                                    <div>Public holidays for
                                                                                                                        <small>Deducted from entitlement</small>
                                                                                                                    </div>
                                                                                                                    <div><b>England & Wales</b></div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <button
                                                                                                                    ...
                                                                                                                    className="continue_btn"
                                                                                                                    id="next6"
                                                                                                                    onClick={() => { next({ id: 'next', form: 'form', count: 5 }); handleAddEmployee(); }}>Next
                                                                                                                    step</button>
                                                                                                            </div>
                                                                                                            <div className="cancel">
                                                                                                                <button
                                                                                                            ...
                                                                                                            <div className="card flex-row">
                                                                                                                {
                                                                                                                    ...
                                                                                                                    Item.profile ? <div className='employeeProfile'><img style={{width: '95px', height: '95px', borderRadius:'50%'}} className="link" src={`http://18.181.84.1:5000/employeeProfile/${Item.profile}`}/></div>
                                                                                                                    :
                                                                                                                <div className="link">
                                                                                                                    <a href="#">{`${Item.first_name.charAt(0)} ${Item.last_name.charAt(0)}`}</a>
                                                                                                                </div>
                                                                                            }
                                                                                                                <div className="profile-detail d-flex flex-column justify-content-center">
                                                                                                                    <p className="name">{`${Item.first_name} ${Item.last_name}`}</p>
                                                                                                                    <div className="">
                                                                                                                        <NavLink to={`/personal-detail/${Item.id}`}>View full profile</NavLink>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div className="eye-link d-flex align-items-center">
                                                                                                                    <NavLink to={`/personal-detail/${Item.id}`}><i className="fa fa-eye" aria-hidden="true"></i></NavLink>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </>
