...
const AdminDetail = () => {
    ...
    const getPersonalDetail = () => {
        ...
        handleShowLoader()
        axios.get(BASE_URL + '/getAdminData',{
          Accept: 'Application',
    ...
    const updateContact = async()=>{
      ...
      await axios.post(BASE_URL +'/updateContactInformation',request,{
        Accept: "Application",
        "Content-Type": "application/json"
      }).then((response)=>{
    ...
    const updatePersonal = async()=>{
      ...
      await axios.post(BASE_URL + '/updatePersonalInformation',request,{
        Accept: "Application",
        'Content-Type': "application/json"
      }).then((res)=>{
    ...
    const updateProfile = async()=>{
      ...
      await axios.post('http://18.181.84.1:5000/api/updateAdminProfile',formData,{
        Accept: 'Application',
        'Content-Type': "application/json"
      }).then((res)=>{
        // console.log(res)
    ...
    const deleteProfile = async()=>{
      let request = {id:state.id}
      await axios.post(`${BASE_URL}/deleteAdminProfile`, request, {
        Accept: "Application",
        "Content-Type": "application/json"
      }).then((response)=>{
        if(response){
          ...
          toast.error("Please Provide Admin Id")
        }
      }).catch((error)=>{
        console.log(error)
                      ...
                      <div className="col-md-12">
                        <div className="user-detail d-flex">
                          {state.profile ? (
                            ...
                            <img
                              ref={uploadedImage}
                              src={`http://18.181.84.1:5000/adminProfile/${state.profile}`}
                            />
                          ...
                          <div className="mail-info">
                            <div className="full-name">
                              ...
                              <p>Director & Development manager</p>
                            </div>
