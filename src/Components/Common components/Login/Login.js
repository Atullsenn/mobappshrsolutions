...
import { handleLogin, toastLoginSuccessfullyMessage, toastLoginFailedMessage } from "../../../Redux/actions/index";
...
const defaultState = {
    email: 'mobappsitsolution@gmail.com',
    password: 'mobapps@1234',
}
...
const Login = () => {
    ...
    const handleLoginUser = () => {
        axios.post(`${baseUrl}/adminLogin`, {
            ...
            dispatch(toastLoginSuccessfullyMessage());
        }).catch((error) => {
            console.log(error)
            dispatch(toastLoginFailedMessage())
            removeUserDetail()
        })
    }
